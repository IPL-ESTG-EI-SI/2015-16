                ...
                do
                {
                    ...
                    switch (type)
                    {
                        ...
                        case ProtocolSICmdType.MODE:
                            algorithm.Mode = (CipherMode)Enum.Parse(typeof(CipherMode), protocol.GetStringFromData());
                            received = "Mode";
                            break;
                        ...
                        case ProtocolSICmdType.SYM_CIPHER_DATA:
                            ...
                            byte[] decryptedData = symmetricsSI.Decrypt(encryptedData);
                            received = "Encrypted Data ["+Encoding.UTF8.GetString(decryptedData)+"]";
                            break;
                        default:
                            received = "EOT";
                            break;
