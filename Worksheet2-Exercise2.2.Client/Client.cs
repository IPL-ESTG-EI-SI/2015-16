    ...
    class ClientWithProtocolSI
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                string plainText = "EI SI 2015/16";
                byte[] encryptedData = symmetricsSI.Encrypt(Encoding.UTF8.GetBytes(plainText));
                ...
                packet = protocol.Make(ProtocolSICmdType.SYM_CIPHER_DATA, encryptedData);
                sendPacketAndWaitForReply("Encrypted Data", packet);
